...
sudo apt install python3 python-pip docker docker-compose git build-essential libssl-dev checkinstall chromium-browser gnome-tweaks gnome-shell-extension-pixelsaver -y &&
